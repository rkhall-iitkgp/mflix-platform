    ...
    return (
        <>
            {!showOtp ?
                ...
                >
                    <Text size="2.2rem" c={'white'} p={'1rem'}>Forget Password</Text>
                    <Flex direction="row" justify="centre"
                        align="center" gap={{ sm: 'lg' }}>
                        <Text size="1.1rem" c={'white'}  >Remember Your Password
                        </Text>
                        <a href="/login" style={{ color: themeOptions.color.textColorNormal }}>Sign in</a>
                    </Flex>
                    <Box
                        className={classes.CentreBoxStyles}>
                        <form onSubmit={form.onSubmit((values) => { handleForgetPassword(values) })}
                ...
                </Box> : <Otp initialValues={formData} ></Otp>}
        </>
    );
}
