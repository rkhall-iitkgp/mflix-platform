      ...
      <Stack
        styles={{
          root: {
            ...
            background:
              'linear-gradient(0deg, rgba(112, 17, 182, 0.05), rgba(112, 17, 182, 0.05)), linear-gradient(321.23deg, rgba(112, 17, 182, 0.2) 5.98%, rgba(0, 0, 0, 0) 66.28%)',
          },
        }}
        pt="xl"
        pl="5%"
            ...
            <Stack ml="6%" gap="xs" mr="lg">
              ...
              >
                <Group gap={themeOptions.fontSize.xs}>
                  <Image src={ImdbImg} component={NextImage} alt="imdb" h={17} unoptimized />
                  <Text fz={themeOptions.fontSize.xs}>{imdbRating}</Text>
                </Group>
                <Group gap={themeOptions.fontSize.xs}>
                  <Image src={TomatoImg} component={NextImage} alt="tomato" h={17} unoptimized />
