    ...
    socket.onmessage = (event: any) => {
      ...
      switch (data.type) {
        ...
        case 'seek':
          ...
          if (playerRef.current) playerRef.current.currentTime = data.seekTime;
          break;
        ...
        case 'outgoing_message':
          ...
          appendMessage({ text: data.content.text, type: 'outgoing_message' });
          break;
