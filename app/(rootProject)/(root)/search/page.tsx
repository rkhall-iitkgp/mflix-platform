...
import MovieBanner, {
    MovieBannerSkeleton,
} from "@/components/Search/MovieBanner";
...
export default function Search() {
    ...
    const [justify, setJustify] = useState<"space-between" | "space-evenly">(
        "space-between",
    );
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            ...
            setJustify(
                window.innerWidth < 1182 ? "space-evenly" : "space-between",
            );
        };
        ...
        >
            ...
            <Stack>
                <Text fw={600} fz={themeOptions.fontSize.xl}>
                    Top results for :{" "}
                    <Text span inherit c={themeOptions.color.textColorNormal}>
                        {search}
                    </Text>
                </Text>
                ...
                {loaded ? (
                    <Stack justify="space-evenly" style={{ rowGap: "2rem" }}>
                        ...
                        >
                            {topRes.map((e, i) => (
                                <MovieBanner key={i} single={single} {...e} />
                            ))}
                        </Group>
                    </Stack>
                ) : (
            ...
            <Stack>
                ...
                <Group
                    ...
                    gap="1%"
                >
                    {makeGroup(moreResults, elementsPerRow).map(
                        (data, index) =>
                            data ? (
