...
export default function MovieContent({ movieData }: { movieData: any }) {
    ...
    const addToWatchList = async () => {
        try {
            ...
            console.error(
                "Error occurred while adding movie to watchlist:",
                error,
            );
        }
    };
    ...
    const removeFromWatchList = async () => {
        try {
            ...
            console.error(
                "Error occurred while removing movie from watchlist:",
                error,
            );
        }
    };
    ...
    const addToFavourites = async () => {
        try {
            ...
            console.error(
                "Error occurred while adding movie to Favourites:",
                error,
            );
        }
    };
    ...
    const removeFromFavourites = async () => {
        try {
            ...
            if (response.ok)
                console.log("Movie removed from favourites successfully");
            else console.error("Failed to remove movie from favourites");
        } catch (error) {
            console.log(
                "Error occured when deleting movie from favourites:",
                error,
            );
        }
    };
    ...
    const styles = createStyles(() => ({
        ...
        movieTitle: {
            fontSize: isSmallScreen
                ? themeOptions.fontSize.l
                : themeOptions.fontSize.xl,
        ...
        buttonContainer: {
            backgroundColor: checked
                ? themeOptions.color.button
                : themeOptions.color.divider,
            width: "fit-content",
            ...
            <Group>
                <Flex justify="center" align="start">
                    <Container>
                        ...
                        <Flex
                            className={classes.otherDetailsContainer}
                            justify="flex-start"
                        >
                            <Flex
                            ...
                            >
                                ...
                                />
                                <p className={classes.detailsText}>
                                    {movieData?.tomatoes?.viewer?.rating}/5
                                </p>
                            </Flex>
                            <Flex
                                className={classes.details}
                        ...
                        <Stack>
                            ...
                            <Flex
                                ...
                                className={`${classes.buttonContainer} ${checked ? classes.checkboxChecked : ""}`}
                            >
                                <Checkbox
                    ...
                    <Stack justify="flex-start" gap="s">
                        ...
                        movieData.directors.length === 0 ? (
                            ...
                            <Stack
                                className={classes.creatersContainer}
                                justify="flex-start"
                                gap="xs"
                            >
                                <p
